import datetime 
# script to create sql files used by snowsql client. 
sql =f'''
...
;
create or replace table test_mf2ndc_{datetime.date.today().strftime("%Y%m%d")}
 (ndc_upc_hri varchar2(11) not null
...
create or replace table test_mf2lab_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2tcgpi_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2dict_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2val_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2sec_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2prc_{datetime.date.today().strftime("%Y%m%d")}
 (ndc_upc_hri varchar2(11) not null
...
create or replace table test_mf2mod_{datetime.date.today().strftime("%Y%m%d")}
 (modifier_code varchar2(6) not null
...
create or replace table test_mf2err_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2gppc_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2name_{datetime.date.today().strftime("%Y%m%d")}
...
create or replace table test_mf2gpr_{datetime.date.today().strftime("%Y%m%d")}
 (generic_product_pack_code varchar2(8) not null
...
create or replace table test_MF2RTDRG_{datetime.date.today().strftime("%Y%m%d")} 
...
;
create OR REPLACE table test_MF2DESC_{datetime.date.today().strftime("%Y%m%d")} 
...
; 
create or replace table test_mf2str_{datetime.date.today().strftime("%Y%m%d")}
 ...
 create or replace table test_mf2idrg_{datetime.date.today().strftime("%Y%m%d")}
 (ingredient_drug_id varchar2(10)  
 ,transaction_cd varchar2(1) 
 ...
 ;
  ...
  create or replace table test_mf2set_{datetime.date.today().strftime("%Y%m%d")}
 ...
 ;
 create or replace table test_mf2ings_{datetime.date.today().strftime("%Y%m%d")}
 (ingredient_set_id varchar2(10)  
 ,ingredient_identifier varchar2(10) 
 ...
 ;
create or replace table test_mf2drg_{datetime.date.today().strftime("%Y%m%d")}
 (concept_type varchar2(5) 
 ,country_code integer
 ,concept_id integer 
 ,transaction_cd varchar2(1) 
...
create or replace table test_mf2drgnm_{datetime.date.today().strftime("%Y%m%d")}
 (concept_type varchar2(5) 
 ,country_code integer
 ,concept_id integer 
 ,transaction_cd varchar2(1) 
...
CREATE OR REPLACE TABLE test_MCMNAME_{datetime.date.today().strftime("%Y%m%d")}
 (
 ...
 create or replace table test_indgind_{datetime.date.today().strftime("%Y%m%d")}
 (GPI varchar2(25),
